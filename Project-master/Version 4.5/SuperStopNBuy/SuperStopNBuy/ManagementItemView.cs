...
namespace SuperStopNBuy
{
    public partial class ManagementItemView : Form
    {
        ...
        public void dataGridItem_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            selectedItem.itemQuantity = Convert.ToInt32(dataGridItem.Rows[rowIndex].Cells[3].Value.ToString());
            selectedItem.itemDesc = dataGridItem.Rows[rowIndex].Cells[4].Value.ToString();
            selectedItem.itemCategory = dataGridItem.Rows[rowIndex].Cells[5].Value.ToString();
        }
