...
namespace SuperStopNBuy
{
    public partial class AdminMain : Form
    {
        ...
        private void datagridviewMain_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            selectedManager.managerDOB = datagridviewMain.Rows[rowIndex].Cells[4].Value.ToString();
            selectedManager.managerAccessLvl = Convert.ToInt32(datagridviewMain.Rows[rowIndex].Cells[5].Value.ToString());
        }
